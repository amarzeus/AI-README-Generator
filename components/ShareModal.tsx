            ...
            >
                <Card className="overflow-hidden">
                    ...
                    <CardContent className="p-8 text-center">
                        <div className="mx-auto bg-blue-100 dark:bg-blue-900/30 rounded-full h-20 w-20 flex items-center justify-center">
                           <PartyPopperIcon />
                        </div>
                        ...
                        <div className="mt-6 space-y-3">
                            <Button onClick={handleCopy} variant="default" className="w-full">
                             ...
                             <div className="flex gap-3">
                                <a href={twitterShareUrl} target="_blank" rel="noopener noreferrer" className="inline-flex items-center justify-center rounded-md text-sm font-semibold h-9 px-4 flex-1 bg-[#1D1F23] text-white hover:bg-gray-800 transition-colors">
                                   <TwitterIcon /> Share on X
                                </a>
                                <a href={linkedInShareUrl} target="_blank" rel="noopener noreferrer" className="inline-flex items-center justify-center rounded-md text-sm font-semibold h-9 px-4 flex-1 bg-blue-600 text-white hover:bg-blue-700 transition-colors">
                                   <LinkedInIcon /> Share on LinkedIn
                                </a>
                            </div>
                        </div>
                         <div className="mt-8">
                            <Button onClick={onClose} variant="primary" className="w-1/2">
                                Done
                            </Button>
                        </div>
                    </CardContent>
